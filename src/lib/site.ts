...
export const siteConfig = {
  ...
  email: "Suhail.work71@gmail.com",
  salesEmail: "Suhail.work71@gmail.com",
  address: {
    /** The address exactly as it is displayed across the site. */
    full: "Maujpur-Shahdara, Delhi - 94",
    street: "Maujpur-Shahdara",
    city: "Delhi",
    region: "Delhi",
    postalCode: "110094",
    country: "IN",
